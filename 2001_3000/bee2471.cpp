...
/*
    solucao dinamica:
    Devemos criar 2 vetores, um de linha e um de coluna, onde em suas reespecitvas posicoes guardam a soma
    de todos os elementos dessas linhas ou coluna. aproveitando o fator de como apenas uma linha e coluna
    terão valores diferentes dos restos, sabemos que essa linha e coluna sao reespectivamente a posicao 
    do elemento diferente! E podemos aplicar a diferença  para saber qual era o numero antes
    se for negativa , entao o numero anterior era maior, se for positva o numero anterior era menor
    logo somamos esse valor ao numero atual naquela posicao será o numero certo.
*/
